...
},{"moment":"node_modules/moment/moment.js"}],"chartsjs-chart-financial.js":[function(require,module,exports) {
var define;
var global = arguments[3];
 ...
 */
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('chart.js')) : typeof define === 'function' && define.amd ? define(['chart.js'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Chart));
})(this, function (Chart) {
  'use strict';
    ...
    scales: {
      x: {
        ...
        ticks: {
          ...
          fontStyle: function fontStyle(context) {
        ...
        afterBuildTicks: function afterBuildTicks(scale) {
          var DateTime = window && window.luxon && window.luxon.DateTime;
          ...
          var val = DateTime.fromMillis(ticks[0].value);
          ...
          var lastMajor = val.get(majorUnit);
  ...
  var FinancialController = /*#__PURE__*/function (_Chart$controllers$ba) {
    _inherits(FinancialController, _Chart$controllers$ba);

    var _super = _createSuper(FinancialController);

    function FinancialController() {
      _classCallCheck(this, FinancialController);

      return _super.apply(this, arguments);
    }

    _createClass(FinancialController, [{
      ...
      value: function getAllParsedValues() {
      ...
      key: "getMinMax",
      value: function getMinMax(scale) {
        ...
        if (scale === meta.iScale) {
          return {
            min: _parsed[0].t,
            max: _parsed[_parsed.length - 1].t
          };
        }
      ...
      key: "calculateElementProperties",
      value: function calculateElementProperties(index, ruler, reset, options) {
        var me = this;
        ...
        var data = me.chart.data.datasets[me.index].data[index];
        var open = vscale.getPixelForValue(data.o);
        var high = vscale.getPixelForValue(data.h);
        var low = vscale.getPixelForValue(data.l);
        var close = vscale.getPixelForValue(data.c);
        return {
          base: reset ? base : low,
          x: ipixels.center,
          y: (low + high) / 2,
  ...
  function getBarBounds(bar, useFinalPosition) {
    var _bar$getProps = bar.getProps(['x', 'low', 'high', 'width', 'height'], useFinalPosition),
        x = _bar$getProps.x,
        y = _bar$getProps.y,
  ...
  var FinancialElement = /*#__PURE__*/function (_Chart$Element) {
    _inherits(FinancialElement, _Chart$Element);

    var _super2 = _createSuper(FinancialElement);

    function FinancialElement() {
      _classCallCheck(this, FinancialElement);

      return _super2.apply(this, arguments);
    }

    _createClass(FinancialElement, [{
      key: "height",
      ...
      value: function getCenterPoint(useFinalPosition) {
        var _this$getProps = this.getProps(['x', 'low', 'high'], useFinalPosition),
            x = _this$getProps.x,
            low = _this$getProps.low,
            high = _this$getProps.high;
      ...
      value: function tooltipPosition(useFinalPosition) {
        var _this$getProps2 = this.getProps(['x', 'open', 'close'], useFinalPosition),
            x = _this$getProps2.x,
            open = _this$getProps2.open,
            close = _this$getProps2.close;
  ...
  var globalOpts$1 = Chart.defaults;
  ...
  var CandlestickElement = /*#__PURE__*/function (_FinancialElement) {
    _inherits(CandlestickElement, _FinancialElement);

    var _super3 = _createSuper(CandlestickElement);

    function CandlestickElement() {
      _classCallCheck(this, CandlestickElement);

      return _super3.apply(this, arguments);
    }

    _createClass(CandlestickElement, [{
      key: "draw",
      value: function draw(ctx) {
        ...
        var x = me.x,
            ...
            low = me.low,
            close = me.close;
        var borderColors = me.borderColor;
    ...
    return CandlestickElement;
  }(FinancialElement);

  Chart.defaults.candlestick = Chart.helpers.merge({}, Chart.defaults.financial);

  var CandlestickController = /*#__PURE__*/function (_FinancialController) {
    _inherits(CandlestickController, _FinancialController);

    var _super4 = _createSuper(CandlestickController);

    function CandlestickController() {
      _classCallCheck(this, CandlestickController);

      return _super4.apply(this, arguments);
    }

    _createClass(CandlestickController, [{
      key: "updateElements",
      value: function updateElements(elements, start, mode) {
        var me = this;
        var dataset = me.getDataset();

        var ruler = me._ruler || me._getRuler();

        for (var i = 0; i < elements.length; i++) {
          var index = start + i;
          var options = me.resolveDataElementOptions(index, mode);
          var baseProperties = me.calculateElementProperties(index, ruler, mode === 'reset', options);

          var properties = _objectSpread(_objectSpread({}, baseProperties), {}, {
            datasetLabel: dataset.label || '',
  ...
  var globalOpts$2 = Chart.defaults;
  ...
  var OhlcElement = /*#__PURE__*/function (_FinancialElement2) {
    _inherits(OhlcElement, _FinancialElement2);

    var _super5 = _createSuper(OhlcElement);

    function OhlcElement() {
      _classCallCheck(this, OhlcElement);

      return _super5.apply(this, arguments);
    }

    _createClass(OhlcElement, [{
      key: "draw",
      value: function draw(ctx) {
        var me = this;
        var x = me.x,
            ...
            low = me.low,
            close = me.close;
        var armLengthRatio = helpers$2.valueOrDefault(me.armLengthRatio, globalOpts$2.elements.ohlc.armLengthRatio);
        var armLength = helpers$2.valueOrDefault(me.armLength, globalOpts$2.elements.ohlc.armLength);
  ...
  var OhlcController = /*#__PURE__*/function (_FinancialController2) {
    _inherits(OhlcController, _FinancialController2);

    var _super6 = _createSuper(OhlcController);

    function OhlcController() {
      _classCallCheck(this, OhlcController);

      return _super6.apply(this, arguments);
    }

    _createClass(OhlcController, [{
      key: "updateElements",
      value: function updateElements(elements, start, mode) {
        var me = this;
        var dataset = me.getDataset();
    ...
    return OhlcController;
  }(FinancialController);

  OhlcController.prototype.dataElementType = OhlcElement;
  Chart.controllers.ohlc = OhlcController;
});
},{"chart.js":"node_modules/chart.js/dist/Chart.js"}],"C:/Users/magic/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/magic/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","chartsjs-chart-financial.js"], null)
//# sourceMappingURL=/chartsjs-chart-financial.30420b69.js.map