...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"lightweightChart.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            dataReverse = data.reverse(); // Переделывают данные массива под нужные

            dataTransform = dataReverse.map(function (_ref2) {
              var time = _ref2.Date,
                  close = _ref2.Close,
                  volume = _ref2.Volume,
                  open = _ref2.Open,
            ...
            firstDataStocks = dataTransform.filter(function (el, inx) {
              if (inx < 100) {
                return el;
              }
            }); // Беру оставшиеся

            secondDataStocks = dataTransform.filter(function (el, inx) {
              if (inx > 100) {
                return el;
              }
            }); // Переделываю дату под нужный формат

            secondDataStocksTransform = secondDataStocks.map(function (_ref3) {
              var time = _ref3.time,
                  close = _ref3.close,
                  open = _ref3.open,
                  high = _ref3.high,
            ...
            incBtn = document.getElementById('speed_inc');
            ...
            getTimer = function getTimer(timeDraw) {
              ...
              timerDraw = setInterval(function () {
                updateChart(); // console.log(timeDrawInit)
              }, timeDrawInit);
            };

            playDrawChart = function playDrawChart(timeDrawInit) {
            ...
            incTime = function incTime() {
              playDrawChart(timeDrawInit -= timeDrawCount);
            };

            decTime = function decTime() {
              playDrawChart(timeDrawInit += timeDrawCount);
            };
            ...
            playBtn.addEventListener('click', function () {
              playDrawChart(timeDrawInit); // markers = []
            ...
            chart.subscribeClick(function (param) {
              ...
              var _iterator = _createForOfIteratorHelper(param.seriesPrices.values()),
                  _step;
...
},{"@babel/runtime/regenerator":"node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"node_modules/@babel/runtime/helpers/asyncToGenerator.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
